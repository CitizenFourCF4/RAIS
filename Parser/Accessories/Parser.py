...
# url='https://brandshop.ru/brendovie-aksessuary/?mfp=83-kategoriya%5B%D0%98%D0%B3%D1%80%D1%83%D1%88%D0%BA%D0%B8%5D'
...
#     }
#   )
# with open('Parser/Accessories/product_links.json', 'w+') as file:
...
with open('Parser/Accessories/product_links.json') as file:
    clothes_list = json.load(file)['goods']
...
for item in clothes_list[7:]:
  ...
  #   if elem['title'].lower() == brand.lower():
  #       brand_id = index
  #       break
  ...
  id+=1
  # with open('Parser/Accessories/goods.json', 'w+') as file:
